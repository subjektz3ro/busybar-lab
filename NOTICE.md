...
|---|---|---|---|
| **busylib** | dependency, and docs vendored under `docs/busylib/` | MIT — **Copyright © 2025 Flipper FZCO** | `docs/busylib/LICENSE` ships alongside the copy, as MIT requires. The snapshot and `scripts/refresh_docs.py` are pinned to upstream revision [`9cf279832928`](https://github.com/busy-app/busylib-py/commit/9cf2798329282a1b728216090e0f5717c0018e20). |
